...
%New version
$$(2)~\frac{\ud}{\ud\theta}E_\theta(W(\bm X)) = \int_{\mathcal X} \frac{\ud}{\ud
\theta}W(\bm x) f(\bm x | \theta) \ud \bm x$$
...
\frac{n}{\lambda}$. It is equal to the Cramer-Rao lower bound. Therefore
