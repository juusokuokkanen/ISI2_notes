...
\end{theorem}
\begin{example}
Recall the the Weibull population from the example \ref{exampleMomentsWeibull1}
for which we eatimated the parameters $a$ and $b$ using the method of moments.
